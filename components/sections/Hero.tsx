...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative pt-28 pb-20 sm:pt-32 sm:pb-24 md:pt-36 md:pb-28 overflow-hidden"
    >
      ...
      <div className="container-tight">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2.5 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-xs font-medium text-slate-700 shadow-sm"
          >
          ...
          <motion.h1
            ...
            className="mt-8 font-display text-[2.25rem] sm:text-[2.75rem] md:text-[3.5rem] lg:text-[4rem] font-semibold leading-[1.08] tracking-tight text-slate-900 text-balance"
          >
            {t.hero.title.part1}{" "}
